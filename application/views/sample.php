...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets/' ?>sample/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="<?php echo base_url().'assets/' ?>sample/plugins/datatables/dataTables.bootstrap.css">
  <link rel="stylesheet" href="<?php echo base_url().'assets/' ?>sample/dist/css/AdminLTE.min.css">
  <link rel="stylesheet" href="<?php echo base_url().'assets/' ?>sample/dist/css/skins/_all-skins.min.css">
</head>
...
<script src="<?php echo base_url().'assets/' ?>sample/plugins/fastclick/fastclick.js"></script>
<script src="<?php echo base_url().'assets/' ?>sample/dist/js/app.min.js"></script>
<script src="<?php echo base_url().'assets/' ?>sample/dist/js/demo.js"></script>
<script>
  $(function () {
    $("#example1").DataTable();
    $('#example2').DataTable({
