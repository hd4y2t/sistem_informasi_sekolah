...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Login</b>TU</a>
  </div>
  
  <div class="login-box-body">
    <p class="login-box-msg">Masukan username dan password</p>

    <form action="<?php echo base_url().'admin/loginproses' ?>" method="post">
      ...
      <div class="text-center" style="color: #af0600;"> <?php $info = $this->session->flashdata('info');
        ...
        <div class="box-footer">
                <button type="submit" class="btn btn-danger pull-right"><i class="fa fa-key"></i> Login</button>
        </div>
      </div>
    </form>
  </div>
